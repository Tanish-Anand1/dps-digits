      ...
      <div className="max-w-7xl mx-auto space-y-8 pt-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-amber-500/20 pb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-mono text-zinc-400">
                Visitor Clicks, Device Analytics & Real-Time IP Telemetry
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/10 hud-box space-y-4">
            ...
            <div className="text-4xl font-black font-mono text-white">
              {metrics.deviceCounts.Desktop || 0}
            </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-white/10 hud-box space-y-4">
            ...
            <div className="text-4xl font-black font-mono text-white">
              {(metrics.deviceCounts.Mobile || 0) + (metrics.deviceCounts.Tablet || 0)}
            </div>
            <div className="text-[10px] font-mono text-zinc-400">
              📱 Smartphones & Tablets
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
            <div className="space-y-1">
              <h2 className="text-lg font-bold text-white font-sans">
                LIVE VISITOR & CLICK AUDIT TRAIL
              </h2>
              <p className="text-xs font-mono text-zinc-400">
                Displaying IP Address, Device Category, OS, Browser & Timestamp
              </p>
            </div>
            ...
            <div className="relative max-w-xs w-full">
              <input
                type="text"
                placeholder="Search IP, device, link..."
                value={searchFilter}
            ...
            <table className="w-full text-left text-xs font-mono">
              <thead className="bg-white/[0.03] text-amber-400 border-b border-white/10 uppercase tracking-wider text-[10px]">
                <tr>
                  ...
                  <th className="p-4">Action / Clicked Target</th>
                ...
                {filteredEvents.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="p-8 text-center text-zinc-500">
                      No telemetry logs recorded matching search criteria.
                    </td>
                  </tr>
                ) : (
                    ...
                    <tr key={evt.id} className="hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="p-4 text-zinc-300 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{evt.deviceType} ({evt.os})</span>
                        </div>
                      </td>
        ...
        >
          ...
          >
            ...
            <div className="space-y-3 text-xs font-mono">
              <div>
                <span className="text-amber-400 block text-[10px]">VISITOR IP:</span>
                <span className="text-white font-bold">{selectedEvent.ip}</span>
              </div>
              <div>
